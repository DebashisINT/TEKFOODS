...
import com.tekfoods.MySingleton
import com.tekfoods.R
import com.tekfoods.app.*
import com.tekfoods.app.NewFileUtils.browseDocuments
import com.tekfoods.app.NewFileUtils.getExtension
import com.tekfoods.app.domain.*
import com.tekfoods.app.types.DashboardType
import com.tekfoods.app.types.FragType
import com.tekfoods.app.types.TopBarConfig
import com.tekfoods.app.uiaction.DisplayAlert
import com.tekfoods.app.utils.*
import com.tekfoods.app.utils.AppUtils.Companion.isProfile
...
import com.tekfoods.features.NewQuotation.AddQuotFormFragment
import com.tekfoods.features.NewQuotation.ViewAllQuotListFragment
import com.tekfoods.features.NewQuotation.ViewDetailsQuotFragment
import com.tekfoods.features.SearchLocation.SearchLocationFragment
import com.tekfoods.features.SearchLocation.locationInfoModel
import com.tekfoods.features.TA.ViewAllTAListFragment
import com.tekfoods.features.achievement.AchievementFragment
import com.tekfoods.features.activities.presentation.*
import com.tekfoods.features.addAttendence.*
import com.tekfoods.features.addAttendence.model.Leave_list_Response
import com.tekfoods.features.addorder.presentation.AddOrderFragment
import com.tekfoods.features.addshop.model.AddShopRequestData
import com.tekfoods.features.addshop.model.AddShopResponse
import com.tekfoods.features.addshop.presentation.AddShopFragment
import com.tekfoods.features.addshop.presentation.OTPVerificationDialog
import com.tekfoods.features.addshop.presentation.ScanImageFragment
import com.tekfoods.features.addshop.presentation.ShowCardDetailsDialog
import com.tekfoods.features.alarm.model.AlarmData
import com.tekfoods.features.alarm.presetation.AttendanceReportFragment
import com.tekfoods.features.alarm.presetation.PerformanceReportFragment
import com.tekfoods.features.alarm.presetation.VisitReportDetailsFragment
import com.tekfoods.features.alarm.presetation.VisitReportFragment
import com.tekfoods.features.attendance.AttendanceFragment
import com.tekfoods.features.attendance.api.AttendanceRepositoryProvider
import com.tekfoods.features.attendance.model.AttendanceRequest
import com.tekfoods.features.attendance.model.AttendanceResponse
import com.tekfoods.features.averageshop.presentation.AverageShopFragment
import com.tekfoods.features.avgorder.presentation.AverageOrderFragment
import com.tekfoods.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.tekfoods.features.billing.presentation.AddBillingFragment
import com.tekfoods.features.billing.presentation.BillingDetailsFragment
import com.tekfoods.features.billing.presentation.BillingListFragment
import com.tekfoods.features.changepassword.presentation.ChangePasswordDialog
import com.tekfoods.features.chat.model.ChatListDataModel
import com.tekfoods.features.chat.model.ChatUserDataModel
import com.tekfoods.features.chat.model.GroupUserDataModel
import com.tekfoods.features.chat.presentation.*
import com.tekfoods.features.chatbot.presentation.ChatBotFragment
import com.tekfoods.features.chatbot.presentation.ChatBotShopListFragment
import com.tekfoods.features.chatbot.presentation.ReportsFragment
import com.tekfoods.features.chatbot.presentation.SelectLanguageDialog
...
import com.tekfoods.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.tekfoods.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.tekfoods.features.commondialogsinglebtn.OnDialogClickListener
import com.tekfoods.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.tekfoods.features.dailyPlan.prsentation.AllShopListFragment
import com.tekfoods.features.dailyPlan.prsentation.DailyPlanListFragment
import com.tekfoods.features.dailyPlan.prsentation.PlanDetailsFragment
import com.tekfoods.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.tekfoods.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.tekfoods.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.tekfoods.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.tekfoods.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.tekfoods.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.tekfoods.features.dashboard.presentation.model.ContentListResponseModel
import com.tekfoods.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.tekfoods.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.tekfoods.features.device_info.presentation.DeviceInfoListFragment
import com.tekfoods.features.document.DocumentRepoFeatureNewFragment
import com.tekfoods.features.document.presentation.DocumentListFragment
import com.tekfoods.features.document.presentation.DocumentTypeListFragment
import com.tekfoods.features.document.presentation.OpenFileWebViewFragment
import com.tekfoods.features.dymanicSection.presentation.AddDynamicFragment
import com.tekfoods.features.dymanicSection.presentation.AllDynamicListFragment
import com.tekfoods.features.dymanicSection.presentation.DynamicListFragment
import com.tekfoods.features.dymanicSection.presentation.EditDynamicFragment
import com.tekfoods.features.gpsDisabilityScreen.GpsDisableFragment
import com.tekfoods.features.home.presentation.HomeFragment
import com.tekfoods.features.homelocation.presentation.HomeLocationFragment
import com.tekfoods.features.homelocation.presentation.HomeLocationMapFragment
import com.tekfoods.features.know_your_state.KnowYourStateFragment
import com.tekfoods.features.lead.LeadFrag
import com.tekfoods.features.lead.LeadInProcessFrag
import com.tekfoods.features.lead.LeadPendingFrag
import com.tekfoods.features.lead.ViewLeadFrag
import com.tekfoods.features.leaveapplynew.LeaveHome
import com.tekfoods.features.localshops.LocalShopListFragment
import com.tekfoods.features.localshops.LocalShopListMapFragment
import com.tekfoods.features.localshops.NearByShopsMapFragment
import com.tekfoods.features.location.*
import com.tekfoods.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.tekfoods.features.login.presentation.LoginActivity
import com.tekfoods.features.logout.presentation.api.LogoutRepositoryProvider
import com.tekfoods.features.logoutsync.presentation.LogoutSyncFragment
import com.tekfoods.features.marketing.presentation.MarketingPagerFragment
import com.tekfoods.features.meetinglist.prsentation.MeetingListFragment
import com.tekfoods.features.member.model.TeamLocDataModel
import com.tekfoods.features.member.model.TeamShopListDataModel
import com.tekfoods.features.member.presentation.*
import com.tekfoods.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.tekfoods.features.micro_learning.presentation.MicroLearningListFragment
import com.tekfoods.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.tekfoods.features.myallowancerequest.MyallowanceRequestFragment
import com.tekfoods.features.myjobs.model.CustomerDataModel
import com.tekfoods.features.myjobs.presentation.*
import com.tekfoods.features.myorder.presentation.MyOrderListFragment
import com.tekfoods.features.myprofile.presentation.MyProfileFragment
import com.tekfoods.features.nearbyshops.presentation.BeatListFragment
import com.tekfoods.features.nearbyshops.presentation.NearByShopsListFragment
import com.tekfoods.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.tekfoods.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.tekfoods.features.newcollection.CollectionDetailsStatusFragment
import com.tekfoods.features.newcollection.CollectionShopListFragment
import com.tekfoods.features.newcollection.NewCollectionListFragment
import com.tekfoods.features.notification.NotificationFragment
import com.tekfoods.features.orderList.NewDateWiseOrderListFragment
import com.tekfoods.features.orderList.NewOrderListFragment
import com.tekfoods.features.orderList.OrderListFragment
import com.tekfoods.features.orderdetail.presentation.OrderDetailFragment
import com.tekfoods.features.orderhistory.ActivityMapFragment
import com.tekfoods.features.orderhistory.OrderhistoryFragment
import com.tekfoods.features.orderhistory.TimeLineFragment
import com.tekfoods.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.tekfoods.features.orderhistory.model.FetchLocationRequest
import com.tekfoods.features.orderhistory.model.FetchLocationResponse
import com.tekfoods.features.orderhistory.model.LocationData
import com.tekfoods.features.performance.GpsStatusFragment
import com.tekfoods.features.performance.PerformanceFragment
import com.tekfoods.features.performance.api.UpdateGpsStatusRepoProvider
import com.tekfoods.features.performance.model.UpdateGpsInputParamsModel
import com.tekfoods.features.permissionList.ViewPermissionFragment
import com.tekfoods.features.photoReg.PhotoAttendanceFragment
import com.tekfoods.features.photoReg.ProtoRegistrationFragment
import com.tekfoods.features.photoReg.RegisTerFaceFragment
import com.tekfoods.features.photoReg.TeamAttendanceFragment
import com.tekfoods.features.quotation.presentation.*
import com.tekfoods.features.reimbursement.presentation.EditReimbursementFragment
import com.tekfoods.features.reimbursement.presentation.ReimbursementDetailsFragment
import com.tekfoods.features.reimbursement.presentation.ReimbursementFragment
import com.tekfoods.features.reimbursement.presentation.ReimbursementListFragment
import com.tekfoods.features.report.presentation.*
import com.tekfoods.features.returnsOrder.*
import com.tekfoods.features.settings.presentation.SettingsFragment
import com.tekfoods.features.shopdetail.presentation.*
import com.tekfoods.features.shopdetail.presentation.api.EditShopRepoProvider
import com.tekfoods.features.stock.StockDetailsFragment
import com.tekfoods.features.stock.StockListFragment
import com.tekfoods.features.stockAddCurrentStock.AddShopStockFragment
import com.tekfoods.features.stockAddCurrentStock.UpdateShopStockFragment
import com.tekfoods.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.tekfoods.features.stockCompetetorStock.AddCompetetorStockFragment
import com.tekfoods.features.stockCompetetorStock.CompetetorStockFragment
import com.tekfoods.features.stockCompetetorStock.ViewComStockProductDetails
import com.tekfoods.features.task.presentation.AddTaskFragment
import com.tekfoods.features.task.presentation.CalenderTaskFragment
import com.tekfoods.features.task.presentation.EditTaskFragment
import com.tekfoods.features.task.presentation.TaskListFragment
import com.tekfoods.features.timesheet.presentation.AddTimeSheetFragment
import com.tekfoods.features.timesheet.presentation.EditTimeSheetFragment
import com.tekfoods.features.timesheet.presentation.TimeSheetListFragment
import com.tekfoods.features.viewAllOrder.CartFragment
import com.tekfoods.features.viewAllOrder.OrderTypeListFragment
import com.tekfoods.features.viewAllOrder.ViewAllOrderListFragment
import com.tekfoods.features.viewAllOrder.ViewCartFragment
import com.tekfoods.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.tekfoods.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.tekfoods.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.tekfoods.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.tekfoods.features.viewPPDDStock.ViewOutstandingFragment
import com.tekfoods.features.viewPPDDStock.ViewPPDDListFragment
import com.tekfoods.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.tekfoods.features.viewPPDDStock.ViewStockFragment
import com.tekfoods.features.weather.presentation.WeatherFragment
import com.tekfoods.mappackage.MapActivity
import com.tekfoods.mappackage.MapActivityWithoutPath
import com.tekfoods.widgets.AppCustomEditText
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xtekfoodslogsample/log").path);
            //27-09-2021
            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xtekfoodslogsample/log").path);
